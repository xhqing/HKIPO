...
|------|---------|------------|---------|-----------|
| 机制A | ~13% | 5%-35%（按认购倍数递增） | 有回拨（三档） | 较高 |
| 机制B | ~87% | 固定（通常10%） | 无回拨 | 极低 |
| 18C机制 | 特专科技公司专用 | 初始5%，最高回拨至20% | 有回拨（单档） | 中等 |

**机制B下**：即使认购11465倍（金叶国际），公开发售仍仅10%，中签率极低。这是新规后最大的结构性变化。

### 2.1a 18C机制详解（2023年3月推出）

18C章是港交所为**特专科技公司**（新一代信息技术、先进硬件及软件、先进材料、新能源及节能环保、新食品和农业技术）专门增设的上市条款，允许未盈利或未达到传统收入门槛的科技企业上市。
...
| 典型公司类型 | 传统行业为主 | 各类公司 | AI/机器人/硬科技 |
| 专业投资者要求 | 无特殊要求 | 无特殊要求 | 至少50%分配给独立定价投资者 |

**策略启示**：

- 18C的20%上限是一个**相对舒适的中间值**——比机制B的10%更易中签，比机制A的35%更不易被散户砸盘
- 单档回拨规则简单可预测：认购<50倍→5%，≥50倍→20%，不存在机制A中"回拨到哪个档位"的不确定性
- 18C公司通常属于AI/科技/高端制造等★★★★★赛道，行业本身加分
- 至少50%分配给专业投资者的要求，意味着国配参与者质量普遍较高
- 入场费参考：18C公司发行价跨度大（从几港元到100+港元），一手费用需要单独评估
